...
The following code was written by Coralie

The following code randomly splits reference list for collaborative work between k=2 collaborators and set proportions for each split (p).
