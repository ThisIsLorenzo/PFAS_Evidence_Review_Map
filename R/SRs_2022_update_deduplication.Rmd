...
### Loading file
```{r, include=FALSE}
dat <- read.csv(here("data/update/COMBINED_SRs_2022_update.csv"))
dim(dat) #[1] 638  21
```
...
write_csv(dat4, file = "SRs_2022_update_deduplicated.csv")
```

Now I am going to deduplicate the file containing the SRs published in 2022 that are already included in our Map and those that are not. So after deduplication I will have all the reviews published in 2022 that are not alrready included in our map.
