...
pacman::p_load(tidyverse, #includes ggplot2, dplyr, and tidyr. Used for data manipulation, cleaning, and visualization.
               ...
               ochRe,
               ggalluvial,
               RColorBrewer) #for working with and visualizing data from the "OpenCoEHST" package
```
...
knitr::kable(select(mdata2,	First_author,
                    Publication_year,
                    Paper_title), caption = "Table of included SRs") %>%
...
## COMBINED
```{r}
(p_subj/p_mesh_headings/p_mesh_qualifiers) - (p_mesh_subject/p_mesh_subject2)
...
tt2 <- srma_trend %>%
  ...
  geom_col(aes(fill = Meta_analysis,
           ...
           width = 0.8,
           size = 0.2) +
  geom_text(aes(fill = fct_relevel(Meta_analysis, c("No",
                                                    "Yes")),
                label = n,
                x = Publication_year, 
                y = n), 
...
# ggsave(here("R_data", "n_included_studies.png"),
#        width = 10,
#        height = 6)
```
