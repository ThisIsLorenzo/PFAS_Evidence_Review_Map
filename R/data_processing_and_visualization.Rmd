...
mdata %>% count(Publication_year) %>% ggplot(aes(x = Publication_year, y = n)) + 
  ...
  theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(angle = 0, size = 13, margin = margin(t = 5, r = 0, l = 0)), axis.text.y = element_text(size = 10, margin = margin(t = 0, r = 5, l = 5)))
