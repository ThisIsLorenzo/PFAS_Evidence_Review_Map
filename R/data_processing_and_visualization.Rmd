...
publ_year <- mdata %>%
  ...
  theme(plot.title = element_text(size = 15, hjust = 0.5),
       axis.text.x = element_text(size = 9, margin = margin(t = 1, r = 0, l = 0)),
       axis.text.y = element_text(size = 9, margin = margin(t = 0, r = 5, l = 5)),
        axis.text.y.right = element_text(size = 6, margin = margin(t = 0, r = 5, l = 5)),
...
NetMatrix_cocitation_plot <- 
  networkPlot(NetMatrix_coupling, 
              n = 30, 
