...
# Make a simple summary table of included papers (mapping + appraisal)
...
time_trend_taxa <- tt_taxa %>%
  ggplot(aes(x = Publication_year,
             y = cumulative,
             color = fct_relevel(Broad_taxa2, c("Mammals",
                                                          "Birds",
                                                          "Ray-finned fish",
                                                          "Others")))) +
  geom_line(size = 0.7) + 
  geom_point(aes(color = Broad_taxa2), size = 3, shape = 21, fill = "white") +
  geom_text(aes(label = n, x = Publication_year, y = cumulative), 
            size = 3.5, 
            hjust = 1.2,
            vjust = -0.5) +
...
Time-trend of SRs publications focused on PFAS vs not focused on PFAS
...
Time-trend of SRs publications investigating each PFAS type
...
t_pfas_types <-  trend_pfas_types %>%
  ggplot(aes(x = Publication_year,
             ...
             color = PFAS_type)) +
  geom_line(size = 0.7) + 
  geom_point(aes(color = PFAS_type), size = 3, shape = 21, fill = "white") +
  geom_text(aes(label = n, x = Publication_year, y = cumulative), 
            size = 3.5, 
            hjust = 1.2,
            vjust = -0.5) +
...
t_pfas_subjects <-  trend_subjects %>%
  ggplot(aes(x = Publication_year,
             y = cumulative,
             color = Human_animal_environment)) +
  geom_line(size = 0.7) + 
  geom_point(aes(color = Human_animal_environment), size = 3, shape = 21, fill = "white") +
  geom_text(aes(label = n, x = Publication_year, y = cumulative), 
            size = 3.5, 
            hjust = 1.2,
            vjust = -0.5) +
