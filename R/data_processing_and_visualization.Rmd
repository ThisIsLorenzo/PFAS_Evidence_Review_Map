...
qtable_long <- data.frame(study = rep(as.factor(studies), each = length(studies)), question = rep(colnames(qtable), each = length(studies)), score = as.vector(qtable), stringsAsFactors = TRUE) #make long format table
