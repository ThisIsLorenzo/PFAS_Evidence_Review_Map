...
Set global code chunk parameters, load packages, and set a colorblind-friendly palette.
...
ggplot(MeSH_qualifiers_counts[, ], aes(x = MeSH_qualifiers, y = n)) +
  ...
  geom_text(aes(label = n),
            position = position_dodge2(width = 2), vjust= 0.5) +
  theme_light() +
...
PieDonut(pd,  aes(Subject, Reporting_guideline, count = n),
         labelposition = 0,
         r0 = 0.5,
         r1 = 0.95,
...
PieDonut(pd,  aes(Subject, COI_statement, count = n),
         labelposition = 0,
         r0 = 0.5,
         r1 = 0.95,
         title = "COI statement",
...
PieDonut(pd,  aes(Subject, Funding_statement, count = n),
         labelposition = 0,
         r0 = 0.5,
         r1 = 0.95,
...
PieDonut(pd,  aes(Subject, Industry_funding, count = n),
         labelposition = 0,
         r0 = 0.5,
         r1 = 0.95,
